...
import { OrderBookFormProps } from "@/types/inventoryReport/OrderBookTypes";
...
const OrderBookForm: FC<OrderBookFormProps> = ({
  getOrderBookLoading,
  form,
  handleSubmit,
  orderBookData,
      ...
      >
        ...
        <div className="flex w-full items-center justify-end gap-2">
          <Button
            ...
            isLoading={getOrderBookLoading}
            isDisabled={getOrderBookLoading}
          >
            Process
          </Button>
          ...
          <Button
            ...
            isDisabled={!(orderBookData.length > 0)}
          >
            Preview
          </Button>
        </div>
