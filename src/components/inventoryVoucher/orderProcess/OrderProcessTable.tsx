...
const OrderProcessTable: FC<OrderProcessTableProps> = ({
  ...
  const orderBookingData: OrderBookingTableData[] =
    useSelector(
  ...
  const { search, setSearch, filtered } =
    useClientTableSearch(safeOrderBookingData);
              ...
              <TableRow key={data.Id}>
                ...
                <TableCell className="w-[120px]">
                  <div className="inline-flex items-center justify-center gap-2">
                    <Tooltip content="View status" delay={200}>
                      <span className="inline-flex">
                        <Button
                          ...
                          onPress={() => handleOpenProcessDialog(data, "View")}
                        >
