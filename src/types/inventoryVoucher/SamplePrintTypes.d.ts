...
export interface SamplePrintFormData {
  ...
  totalRate: string;
  /** Multi-design print sections (used by print popup). */
  designs?: SamplePrintDesignPrintData[];
}

export interface SamplePrintDesignPrintData {
  designId: string;
  designName: string;
  designNo: string;
  wt: string;
...
export interface SamplePrintDesignTableData {
  designId: string;
  designName: string;
  designNo: string;
  wt: string;
...
export interface SamplePrintProps {
  ...
  designTableData: SamplePrintDesignTableData[];
  handleDeleteDesignTableData: (designId: string) => void;
